<template>
	<div class="content" :style='{"alignContent":"flex-start","padding":"0","overflow":"hidden","background":"rgb(17, 17, 17)","flexDirection":"column","display":"flex","width":"100%","position":"relative","user-select":"none","height":"100%"}'>
		<div :style='{"width":"100%","padding":"0","margin":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20250320/c0e5b4ad2a3d44258947b002f3325608.png) center center/100% 100%","height":"100px"}'>
			<!-- 标题 -->
			<div :style='{"padding":"0 0 0 20px","margin":"0","color":"transparent","textAlign":"left","background":"linear-gradient(to bottom,#cce9e8, rgba(0, 206, 209, 1)) text","width":"auto","letterSpacing":"2px","lineHeight":"80px","fontSize":"24px","fontWeight":"700","height":"100%"}'>欢迎使用 {{this.$project.projectName}}</div>
			<!-- 时间 -->
			<div :style='{"top":"0","color":"#fff","display":"inline-block","lineHeight":"80px","fontSize":"22px","position":"absolute","right":"20px","height":"80px"}'>{{ dates }} <span @click="backClick" style="cursor:pointer;padding: 0 0 0 8px;">管理界面</span></div>
		</div>
		<div :style='{"padding":"20px","flex":"auto","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"0","zIndex":"2"}'>
			<div :style='{"width":"25%","padding":"0","flexDirection":"column","background":"none","display":"flex","gap":"15px"}'>
				<div class="echarts1">
					<div :style='{"padding":"0 0 0 50px","margin":"0","textAlign":"left","background":"url(https://codegen.caihongy.cn/20250103/48056e48009f429ebcf90571a4f36284.png) no-repeat left center","flex":"none","width":"100%","height":"51px"}'>
						<div :style='{"color":"#fff","textAlign":"left","background":"none","letterSpacing":"2px","fontSize":"18px","lineHeight":"40px","fontWeight":"500"}'>
							工作温度
						</div>
					</div>
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="devicedetectionChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"padding":"0 0 0 50px","margin":"0","textAlign":"left","background":"url(https://codegen.caihongy.cn/20250103/48056e48009f429ebcf90571a4f36284.png) no-repeat left center","flex":"none","width":"100%","height":"51px"}'>
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="devicedetectionChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"padding":"0 0 0 50px","margin":"0","textAlign":"left","background":"url(https://codegen.caihongy.cn/20250103/48056e48009f429ebcf90571a4f36284.png) no-repeat left center","flex":"none","width":"100%","height":"51px"}'>
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="devicedetectionChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"padding":"0","margin":"0 20px","flexWrap":"wrap","flexDirection":"column","flex":"auto","background":"none","display":"flex","width":"0","height":"100%"}'>
				<!-- 统计 -->
				<div :style='{"alignContent":"center","padding":"0","margin":"0 0 20px 0","color":"#fff","alignItems":"center","background":"none","display":"flex","gap":"12px","width":"100%","fontSize":"14px","justifyContent":"space-evenly","height":"160px"}'>

					<div :style='{"padding":"0","margin":"0","alignItems":"center","background":"url(\"https://codegen.caihongy.cn/20250103/bf51fb90c3a24185bb215cd4d6b411cd.png\")  no-repeat center -110px","flexDirection":"row","flex":"1 1 auto","display":"flex","width":"126px","position":"relative","justifyContent":"space-evenly","height":"160px","maxWidth":"200px"}'>
						<div :style='{"width":"43px","margin":"0 10px","flex":"none","display":"none","height":"43px"}'></div>
						<div :style='{"padding":"80px 0 0 0","alignItems":"center","flexWrap":"wrap","flexDirection":"column","flex":"auto","display":"flex","width":"0","justifyContent":"center","height":"auto"}'>
							<div :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"inherit","textAlign":"center","width":"100%","lineHeight":"24px","fontSize":"inherit","position":"relative","height":"24px"}'>设备检测总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"18px","color":"rgb(250, 212, 0)","fontWeight":"700","order":"20"}'>{{devicedetectionCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts7">
					<div :style='{"padding":"0 0 0 50px","margin":"0","textAlign":"left","background":"url(https://codegen.caihongy.cn/20250103/7e1b7534a83645308b87aa0f5fe63e86.png) no-repeat left center","flex":"none","width":"100%","height":"51px"}'>
						<div :style='{"fontSize":"18px","lineHeight":"40px","color":"#fff","textAlign":"left","background":"none","fontWeight":"500"}'>
							设备检测
						</div>
					</div>
					<el-table id="devicedetectionTable" :data="devicedetectionList" border :stripe="true" :style='{"border":"none !important","width":"100%","padding":"0","background":"none"}'>
						<el-table-column :resizable="true" :sortable="false" prop="title" label="名称">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="ratedvoltage" label="额定电压(kv)">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="ratedfrequencyhz" label="额定频率(Hz)">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="ratedcurrent" label="额定电流(A)">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="ratedshortcircuitbreakingcurrentka" label="额定短路开断电流(kA)">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="effectivevalueofratedshor" label="额定短时耐受电流有效值(kA)">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="ratedshortcircuitclosingcurrent" label="额定短路关合电流(KA)">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="ratedpeakwithstandcurrentka" label="额定峰值耐受电流(kA)">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="powerfrequencywithstan" label="工频耐受电压(kV)">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="lightningimpulsewithstan" label="雷电冲击耐受电压(kV)">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="protectiongrade" label="防护等级">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="equipmentstatus" label="设备状态">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="runningtime" label="工作时长">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="operationtemperature" label="工作温度">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="workingpressure" label="工作压力">
						</el-table-column>
					</el-table>
				</div>
				<div class="forecast-box" :style='{"padding":"20px","margin":"0","alignItems":"flex-start","flexDirection":"row","display":"flex","transition":"0.3s","justifyContent":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20250109/ead18fd8b6c4467ba1dda86d96b8f407.png) center / 100% 100%","flex":"0 0 auto","gap":"8px","width":"100%","height":"auto","order":"20"}'>
					<div :style='{"border":"1px solid rgba(0, 206, 209, 1)","padding":"0 10px","margin":"0","borderRadius":"10px","alignItems":"center","display":"flex","width":"calc(33.33% - 8px)","order":"2"}'>
						<div :style='{"width":"auto","fontSize":"14px","color":"#999","textAlign":"left"}'>
							名称
						</div>
						<input :style='{"border":"none","margin":"0 0 0 10px","outline":"none","color":"#fff","flex":"auto","background":"none","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.title" placeholder="请输入名称"></input>
					</div>
					<div :style='{"border":"1px solid rgba(0, 206, 209, 1)","padding":"0 10px","margin":"0","borderRadius":"10px","alignItems":"center","display":"flex","width":"calc(33.33% - 8px)","order":"2"}'>
						<div :style='{"width":"auto","fontSize":"14px","color":"#999","textAlign":"left"}'>
							工作温度
						</div>
						<input :style='{"border":"none","margin":"0 0 0 10px","outline":"none","color":"#fff","flex":"auto","background":"none","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.operationtemperature" placeholder="请输入工作温度"></input>
					</div>
					<div :style='{"border":"1px solid rgba(0, 206, 209, 1)","padding":"0 10px","margin":"0","borderRadius":"10px","alignItems":"center","display":"flex","width":"calc(33.33% - 8px)","order":"2"}'>
						<div :style='{"width":"auto","fontSize":"14px","color":"#999","textAlign":"left"}'>
							工作压力
						</div>
						<input :style='{"border":"none","margin":"0 0 0 10px","outline":"none","color":"#fff","flex":"auto","background":"none","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.workingpressure" placeholder="请输入工作压力"></input>
					</div>
					<div :style='{"width":"100%","letterSpacing":"2px","fontSize":"18px","color":"#fff","fontWeight":"500","order":"1"}'>
						预测设备状态：{{form.equipmentstatus}}
					</div>
					<div @click="forecastClick" :style='{"border":"1px solid rgba(0, 206, 209, 1)","cursor":"pointer","color":"rgb(250, 212, 0)","borderRadius":"5px","textAlign":"center","background":"none","width":"140px","lineHeight":"36px","height":"36px","order":"3"}'>
						立即预测
					</div>
				</div>
			</div>
			<div :style='{"padding":"0","flexWrap":"wrap","flexDirection":"column","background":"none","display":"flex","gap":"15px","width":"25%"}'>
				<div class="echarts4">
					<div :style='{"padding":"0 0 0 50px","margin":"0","textAlign":"left","background":"url(https://codegen.caihongy.cn/20250103/e010405843e1480eb2b0ceae12587f47.png) no-repeat left center","flex":"none","width":"100%","height":"51px"}'>
						<div :style='{"fontSize":"18px","lineHeight":"40px","color":"#fff","textAlign":"left","background":"none","fontWeight":"500"}'>
							工作时长
						</div>
					</div>
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="devicedetectionChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"padding":"0 0 0 50px","margin":"0","textAlign":"left","background":"url(https://codegen.caihongy.cn/20250103/e010405843e1480eb2b0ceae12587f47.png) no-repeat left center","flex":"none","width":"100%","height":"51px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="devicedetectionChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts6">
					<div :style='{"padding":"0 0 0 50px","margin":"0","textAlign":"left","background":"url(https://codegen.caihongy.cn/20250103/e010405843e1480eb2b0ceae12587f47.png) no-repeat left center","flex":"none","width":"100%","height":"51px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="devicedetectionChart6" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
		...
		methods:{
			forecastClick(row) {
				this.$confirm(`是否进行数据预测?`, "提示", {
					...
					this.$http({
						url: 'devicedetectionforecast/save',
						method: 'post',
						...
						if(res.data&&res.data.code==0){
							...
							this.$http({
								...
								if(obj.data&&obj.data.code==0){
									this.$http({
										url: 'devicedetectionforecast/info/' + res.data.data,
										method: 'get'
									}).then(rs2=>{
			...
			getdevicedetectionList() {
				...
				this.$http({
					...
					if (data && data.code === 0) {
						this.devicedetectionList = data.data.list;
						let div = document.getElementById('devicedetectionTable')
						var scrollTop = -1
						function move() {
							if (div){
						...
						this.devicedetectionTimer = setInterval(move, 2000);
						div.addEventListener('mouseenter', e => {
							e.stopPropagation()
							clearInterval(this.devicedetectionTimer);
						})
					...
					this.$http({
						...
						if (data && data.code === 0) {
							...
							for(let i=0;i<seriesObj.length;i++){
								if(seriesObj[i].type=='line') {
									seriesObj[i] = Object.assign(seriesObj[i] ,this.line5.series)
								}else {
									seriesObj[i] = Object.assign(seriesObj[i] ,this.line5.series2)
								}
							}
			...
			// 统计接口6
			devicedetectionChat6() {
				this.$nextTick(()=>{

					var devicedetectionChart6 = echarts.init(document.getElementById("devicedetectionChart6"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							devicedetectionChart6.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								devicedetectionChart6.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
...
<style lang="scss" scoped>
	...
	.el-table /deep/ .el-table__body-wrapper tbody tr.el-table__row--striped td {
		background: rgba(8, 90, 140, 0.14);
	}
	
	.el-table /deep/ .el-table__body-wrapper tbody tr:hover td {
				padding: 12px 0;
				color: #fff;
				background: rgba(8, 90, 140, 0.3);
				border-color: #eee;
				border-width: 0;
				border-style: solid;
				text-align: left;
	...
	.echarts1 {
				...
				background: url(http://codegen.caihongy.cn/20250109/ead18fd8b6c4467ba1dda86d96b8f407.png) center / 100% 100%;
				flex: 1 1 auto;
				display: flex;
				width: 100%;
				transition: 0.3s;
