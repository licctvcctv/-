	...
	<div>
		...
		<div class="container">
			<el-form class='rgs-form animate__animated animate__' v-if="pageFlag=='register'" ref="registerForm" :model="registerForm" :rules="rules">
				<div class="rgs-form2">
					<div class="title">基于大数据的电气设备故障检测注册</p></div>
					...
					<el-form-item class="list-item" v-if="tableName=='yonghu'" prop="dianhua">
						<div class="label" :class="changeRules('dianhua')?'required':''">电话：</div>
